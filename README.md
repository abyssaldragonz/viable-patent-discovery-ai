# PatentSpark: An AI Agent Concept for Viable Patent Discovery
...
2. Clone the repository: `git clone https://github.com/abyssaldragonz/viable-patent-discovery-ai.git`
